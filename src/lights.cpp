...
Teleruptor teleruptors[] = {  Teleruptor(CONTROLLINO_A0, CONTROLLINO_RELAY_00) ,
		...
		Teleruptor( CONTROLLINO_A6, CONTROLLINO_RELAY_08),
		Teleruptor( CONTROLLINO_A7, CONTROLLINO_RELAY_09),
		Teleruptor( CONTROLLINO_IN0, CONTROLLINO_D0),
		Teleruptor( CONTROLLINO_IN1, CONTROLLINO_D1),
};

MotionSpot spot[] =
		{
				MotionSpot(CONTROLLINO_A8,CONTROLLINO_D2, CONTROLLINO_D3, CONTROLLINO_RELAY_06),
				MotionSpot(CONTROLLINO_A9,CONTROLLINO_D4, CONTROLLINO_D5, CONTROLLINO_RELAY_07),
		};
