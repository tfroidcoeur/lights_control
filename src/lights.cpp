...
MotionSpot spot[] =
		{
				MotionSpot(CONTROLLINO_A8,CONTROLLINO_D2, CONTROLLINO_D3, CONTROLLINO_RELAY_08),
				MotionSpot(CONTROLLINO_A9,CONTROLLINO_D4, CONTROLLINO_D5, CONTROLLINO_RELAY_09),
		};
