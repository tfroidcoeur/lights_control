...
Controller::Controller() : buttonCA3(500, 2000), buttonCA4(500, 2000),
  ...
  teleruptorCA6 =
    new Teleruptor(buttonCA6.getShortSignal(), relay[6], "CA6", huis);
  huis->addNode(teleruptorCA6);
  teleruptorCA7 =
    new Teleruptor(buttonCA7.getShortSignal(), relay[7], "CA7", huis);
  huis->addNode(teleruptorCA7);
  teleruptorCA8 =
    new Teleruptor(buttonCA8.getShortSignal(), relay[8], "CA8", huis);
  huis->addNode(teleruptorCA8);
  teleruptorDM2 =
    new Teleruptor(buttonDM2.getShortSignal(), relay[9], "DM2", huis);
...
void Controller::setupLivingGlobal() {
  ...
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorDM1,
                                                      &Teleruptor::save));
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorDM1,
                                                      &Teleruptor::off));
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorCA4,
                                                      &Teleruptor::save));
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorCA4,
                                                      &Teleruptor::off));
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorCA6,
                                                      &Teleruptor::save));
  living_off_actions.append(new FunAction<Teleruptor>(teleruptorCA6,
                                                      &Teleruptor::off));
...
void Controller::setupBureau() {
  bureau_off_actions.append(new FunAction<Teleruptor>(teleruptorCA7,
                                                      &Teleruptor::off));
  bureau_off_actions.append(new FunAction<Teleruptor>(teleruptorCA8,
                                                      &Teleruptor::off));
...
void Controller::setupGlobal() {
  ...
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorDM1,
                                                      &Teleruptor::off));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA4,
                                                      &Teleruptor::save));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA4,
                                                      &Teleruptor::off));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA6,
                                                      &Teleruptor::save));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA6,
                                                      &Teleruptor::off));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA7,
                                                      &Teleruptor::save));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA7,
                                                      &Teleruptor::off));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA8,
                                                      &Teleruptor::save));
  global_off_actions.append(new FunAction<Teleruptor>(teleruptorCA8,
                                                      &Teleruptor::off));
